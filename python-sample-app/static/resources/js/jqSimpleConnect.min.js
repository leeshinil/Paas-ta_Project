    ...
    if (b.left == c.left || b.top == c.top) {
        ...
        if (a.anchorA != a.anchorB) {
            ...
            if (a.anchorA == "vertical") {
                ...
                h.top = b.top;
                i.top = c.top;
                jqSimpleConnect._positionHorizontalLine(d, b, h, a.radius, a.roundedCorners);
                jqSimpleConnect._positionHorizontalLine(e, c, i, a.radius, a.roundedCorners);
...
jqSimpleConnect._positionHorizontalLine = function(a, b, c, d, e) {
    var f = parseInt(d / 2, 10);
    a.css("top", b.top - f);
...
jqSimpleConnect.connect = function(a, b, c) {
    ...
    var e = '<div id="divUniqueIdentifier" class="jqSimpleConnect ' + d.id + '" ' + 'style="width:' + d.radius + "px; " + "height:" + d.radius + "px; " + "background-color:" + d.color + "; " + (d.roundedCorners ? "border-radius:" + parseInt(d.radius / 2, 10) + "px; -webkit-border-radius:" + parseInt(d.radius / 2, 10) + "px; -moz-border-radius:" + parseInt(d.radius / 2, 10) + "px; " : "") + 'position:absolute;"></div>';
